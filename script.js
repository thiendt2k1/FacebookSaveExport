var fb_dtsg=require("DTSGInitialData").token,uid=require("CurrentUserInitialData").USER_ID,cursor="",data=[],template=e=>{download(' <html>
  <head>
    <title>Danh sách link đã lưu</title>
  ...
  <body>
    <script>
      data = "'+e+'"; < \/script> < div class = "container" > < div class = "row" > < div class = "col-md-12" > < h3 class = "text-center" > Danh sách link đã lưu < /h3> < div class = "text-center"
      style = "margin-bottom: 10px" > Code by Nguyen Huu Dat - J2TEAM Community < /div> < table class = "table table-bordered table-striped"
      id = "table" > < thead class = "thead-dark" > < tr > < th > # < /th> < th class = "text-center" > Hình ảnh < /th> < th > Chi tiết < /th> < /tr> < /thead> < tbody > < /tbody> < /table> < /div> < /div> < /div> < script src = "https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"
      crossorigin = "anonymous" > < \/script> < script src = "https://cdn.jsdelivr.net/npm/vanilla-lazyload@17.3.0/dist/lazyload.min.js" > < \/script> < script >
        var data2 = JSON.parse(decodeURIComponent(escape(window.atob(data))));
      for (i = 0; i < data2.length; i++) {
        $("#table > tbody").append(\' < tr > < td class = "align-middle" > \'+(i+1)+\'</td> < td > < img class = "img-fluid rounded mx-auto d-block lazy"
          ...
          data - src = "\'+data2[i].image+\'" > < /td> < td > < div class = "des"
          style = "word-break: break-word;" > < div > < img src = "\'+data2[i].sourceImage+\'"
          style = "" / > Lưu từ\ '+data2[i].sourceType+\'  < a target = "_blanks"
          href = "https://fb.com/\'+data2[i].sourceID+\'"
          target = "_blanks" > \'+data2[i].sourceName+\'</a> < div > < div class = "mt-2 font-weight-bold" > \'+data2[i].title+\'</div> < div class = "float-right mt-3" > < a href = "\'+data2[i].url+\'"
          target = "_blanks"
          class = "btn btn-info btn-sm" > < i class = "fas fa-file-import" > < /i> Xem bài viết < /a> < /div> < /div> < /td> < /tr>\');};var lazyLoadInstance = new LazyLoad({});<\/script> < /body> < /html>',"SavedFB.html")},download=(e,a,t)=>{var s=new Blob([e],{type:t});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(s,a);else{var i=document.createElement("a"),n=URL.createObjectURL(s);i.href=n,i.download=a,document.body.appendChild(i),i.click(),setTimeout(function(){document.body.removeChild(i),window.URL.revokeObjectURL(n)},0)}},encodeHTML=e=>e.replace(/([\u00A0 - \u9999 < > & ])(. | $) / g,
          function(e, a, t) {
            return "&" !== a || "#" !== t ? (/[\u00A0-\u9999<>&]/.test(t) && (t = "&#" + t.charCodeAt(0) + ";"), "&#" + a.charCodeAt(0) + ";" + t) : e
          }), checkExit = e => {
          try {
            return e()
          } catch (e) {
          ...
          console.log("Đang lấy dữ liệu! Vui lòng chờ trong giây lát..."), "" !== e && (e = `"cursor":"${e}",`);
          const a = await fetch("https://www.facebook.com/api/graphql/", {
            body: `av: 100000034778747&__user=${encodeURIComponent(uid)}&__dyn=&fb_dtsg=${encodeURIComponent(fb_dtsg)}&fb_api_req_friendly_name=CometSaveDashboardAllItemsPaginationQuery&variables=${encodeURIComponent(`{"content_filter":null,"count":10,${e}"scale":1}`)}&server_timestamps=true&doc_id=3196659713724388`,
            method: "POST",
            mode: "cors",
            credentials: "include",
            headers: {
          ...
          let s = !1;
          if (checkExit(() => t.data.viewer.saver_info.all_saves.page_info.has_next_page) && (s = t.data.viewer.saver_info.all_saves.page_info.has_next_page), !0 === s) get_posts(t.data.viewer.saver_info.all_saves.page_info.end_cursor);
          else {
